...
;
;  Doooooo oooooo  = display octal memory range
;  Joooooo         = jump to octal address
;  Moooooo         = prompt to modify memory at octal address
;
; **************************************************************
;
...
STACK   EQU     04000H          ;MUST BE VALID RAM, NOT ROM!

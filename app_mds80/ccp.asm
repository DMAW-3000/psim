...
staddr:	dw	0	;starting address of current fillfcb request
;
...
dstr db 'direct cmd', 0
estr db 'erase cmd', 0
tstr db 'type cmd', 0
rstr db 'rename cmd', 0
...
userfunc:
	...
	cpi	' '
	jnz user0
	; no file name but may be disk change
	lda sdisk
	ora a
	jz endcom ; no disk or command
	dcr a
	sta cdisk
	call setdiska
	call select
